...
import web.sportObject.dto.SportObjectPositionDtoFactory;
import web.sportObject.service.SportObjectPositionDtoValidator;
import web.common.BaseController;
import web.common.dto.FieldErrorDto;

@RestController
@Setter(onMethod_ = { @Autowired })
final class SportObjectPositionDirectorController extends BaseController {
